...
public abstract class TestPresenter extends Presenter<TestView> implements TestUiHandlers {
  ...
  public void onEventReceived(BrixEvent event) {
    if (event.isSameType(SampleEvent.class)) {
      //      callSample((SampleEvent)event);
    }
  }
